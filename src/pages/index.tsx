...
export default function DomovskaObrazovka() {
  return (
    <main className='w-screen h-screen pt-[200px] text-center bg-bg-main flex flex-col items-center justify-between'>
      <div><div className='font-bold pl-5 flex flex-row gap-2 text-color-primary text-4xl'>ToDo <span>App</span><MdOutlineTaskAlt size={50}/></div>
      <Link href="/todoapp">
      <p className='font-bold text-color-text text-2xl pb-10'>#1 to-do checklist App</p>
